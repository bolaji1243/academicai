...
import com.schoolproject.app.universitystudent.dto.response.AssignmentResponse;
...
public class UniStudentDashboardService {
    ...
    public DashboardResponse getDashboard() {
        ...
        return DashboardResponse.builder()
                ...
                .upcomingTests(dueThisWeek.stream()
                        .map(assignment -> AssignmentResponse.from(
                                assignment,
